...
const Loader = () => {
  return (
    // <div
    //   role="status"
    //   className="p-4 rounded border border-gray-200 shadow  md:p-6 dark:border-gray-700 animate-pulse flex flex-col"
    // >
    //   <div className="flex justify-center items-center mb-4  bg-gray-300 rounded dark:bg-gray-700">
    //     <svg
